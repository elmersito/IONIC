...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $sql = "SELECT id, campo1, campo2 FROM usuarios";
    ...
    $campo1 = $_POST['campo1'];
    $campo2 = $_POST['campo2'];
    $sql = "INSERT INTO usuarios (campo1, campo2) VALUES ('$campo1', '$campo2')";
    ...
    $sql = "UPDATE usuarios SET campo1 = '$campo1', campo2 = '$campo2' WHERE id = $id";
